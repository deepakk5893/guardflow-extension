...
## Overview
Niyantra is a free browser extension that detects and prevents accidental secret leaks in AI chat interfaces. We take your privacy seriously.

## Data Collection & Storage
- **Zero Server Communication:** Niyantra processes all data locally on your device. We do NOT send any information to external servers.
...
## What Data We Store
Niyantra stores only local extension statistics in your browser:
...
## What We Detect
Niyantra detects common secret patterns including:
...
Niyantra does not integrate with any third-party services or analytics platforms.
